...
PRE_CACHE_PHRASES = [
    ...
    "رقم 1 النواة: هي مخ الخلية ومركز التحكم، وجواها الحمض النووي DNA!",
    "رقم 2 الميتوكوندريا: دي مصنع الطاقة الحقيقي اللي بيولد مركبات ATP!",
    "رقم 3 السيتوبلازم: السائل الهلامي الحيوي اللي بتسبح فيه كل العضيات!",
    "عنصر الهيدروجين: أبسط وأخف عناصر الكون وعدده الذري 1!",
    "عنصر الأكسجين: غاز التنفس والحياة الأساسي وعدده الذري 8!",
    "عنصر الكربون: أساس الكيمياء العضوية وكل الكائنات وعدده الذري 6!",
    "عنصر الحديد: معدن القوة والصلابة وهيموجلوبين الدم وعدده الذري 26!",
    "الحالة الصلبة: الجزيئات متراصة جداً وبتتحرك حركة اهتزازية بس في مكانها!",
    "الحالة السائلة: الجزيئات بتنزلق فوق بعضها وبتاخد شكل الوعاء!",
    "الحالة الغازية: الجزيئات حرة وسريعة جداً وبتملأ أي مساحة متاحة!",
    "الله ينور عليك يا بطل! إجابة صحيحة وممتازة!",
    "معلش يا بطل، ركز في السؤال اللي جاي وهتعوضها!",
    "عاش يا بطل! درجتك كاملة 3 من 3!",
